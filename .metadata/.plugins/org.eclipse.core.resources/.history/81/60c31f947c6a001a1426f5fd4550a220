...
public class PJF_NP{
	...
	public PJF_NP(int []a,int []b,int []c) {
		...
		System.out.print("Enter Priorities(1-highest priority,..,n-lowest priority:");
		for(i=0;i<n;i++)	pq[i]=ip.nextInt();
		*/
